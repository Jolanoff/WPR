...
function HuurAanvragenHistoryPage() {
  const { isAuthorized } = UseAuthorization(["ParticuliereHuurder", "ZakelijkeHuurder", "Bedrijf", "WagenParkBeheerder"]);
            ...
            {huuraanvragen.map((aanvraag) => (
              ...
              >
                <h2 className="text-xl font-semibold">
                  {aanvraag.voertuigNaam} {aanvraag.voertuigType}
                </h2>
                ...
                <p>
                  <strong>Aantal KM:</strong> {aanvraag.verwachteKilometers == 300 ? (
                    <span className="text-blue-500">+300</span>
                  ) : (aanvraag.verwachteKilometers)}
                </p>
                <p
                  className={`font-semibold ${aanvraag.status
                    ? "text-red-500"
                    : "text-green-500"
                    }`}
                >
